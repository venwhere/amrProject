...
import com.sun.cache.RedisCacheManager;
import com.sun.realm.CustomerCredentialsMatcher;
import com.sun.realm.MemberRealm;
import com.sun.session.RedisSessionDAO;
...
public class ShiroConfig {
	...
	@Bean
	public Realm getRealm() {// 1、获取配置的Realm 
	...
	public RememberMeManager getRememberManager() { // 5
		...
		SimpleCookie cookie = new SimpleCookie("HUANGJAVA-RememberMe");
	...
	public DefaultWebSessionManager getSessionManager(SessionDAO sessionDAO,
		...
		SimpleCookie sessionIdCookie = new SimpleCookie("SUN-session-id");
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
		...
		shiroFilterFactoryBean.setSuccessUrl("/pages/login");	// 设置跳转成功页
		...
		filterChainDefinitionMap.put("/one/**", "authc");
		filterChainDefinitionMap.put("/test/**", "roles[dept]");
